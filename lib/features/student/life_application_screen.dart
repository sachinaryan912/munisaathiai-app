...
class _BodyState extends State<_Body> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        widget.list.isEmpty
            ? ListView(children: const [SizedBox(height: 120), EmptyView(title: 'No entries yet', subtitle: 'Apply a chapter\'s learning to your life.', icon: HugeIcons.strokeRoundedHeartHandshake)])
            : ListView.builder(
