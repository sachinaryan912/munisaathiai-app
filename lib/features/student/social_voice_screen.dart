...
class _BodyState extends State<_Body> {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: [
        widget.list.isEmpty
            ? ListView(children: const [SizedBox(height: 120), EmptyView(title: 'No entries yet', subtitle: 'Log a social odd you raised your voice against.', icon: LucideIcons.megaphone)])
            : ListView.builder(
