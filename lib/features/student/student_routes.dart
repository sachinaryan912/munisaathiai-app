...
List<StatefulShellBranch> studentBranches() => [
      ...
      StatefulShellBranch(routes: [GoRoute(path: '/student/videos', builder: (context, state) => const AppShell(title: 'Video Gallery', showAiFab: false, body: VideoGalleryScreen()))]),
